<template>
    <div class="PipelineMainData">
        <div
            class="flex justify-between bg-white p-5 border-4 border-transparent cursor-pointer rounded-xl shadow-lg hover:border-gray-300 mb-5" v-for="data in props.tasks">
            <div class="text-left">
...
const emit = defineEmits(['show']); // 确保你定义了正确的事件名
